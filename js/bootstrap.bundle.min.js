...
document.addEventListener("DOMContentLoaded", () => {
    ...
    console.log("GameArena loaded successfully!");
    ...
    function showSuccessMessage() {
        ...
        success.innerHTML = `
            ...
            <span>Thanks for contacting GameArena. We will get back to you soon.</span>
        `;

        success.style.marginTop = "20px";
        success.style.padding = "15px";
        success.style.borderRadius = "6px";
        success.style.background = "rgba(183, 255, 0, 0.08)";
        success.style.border =
            "1px solid rgba(183, 255, 0, 0.3)";
        success.style.color = "#b7ff00";

        success.style.display = "flex";
        success.style.flexDirection = "column";
        success.style.gap = "4px";
    ...
    document
        .querySelectorAll(
            ".game-card, .team-card, .service-card"
        )
        .forEach(card => {
    ...
    if (signInButton) {
        ...
        signInButton.addEventListener(
            ...
            () => {
                ...
                alert(
                    "Welcome to GameArena! Sign-in functionality coming soon."
                );
    ...
    if (viewAllButton) {
        ...
        viewAllButton.addEventListener(
            ...
            event => {
                ...
                viewAllButton.style.pointerEvents =
                    "none";
    ...
    if (tournamentButton) {
        ...
        tournamentButton.addEventListener(
            ...
            () => {
                ...
                console.log(
                    "Tournament registration selected."
                );
